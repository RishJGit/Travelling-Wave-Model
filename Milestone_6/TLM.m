...
InputParasL.E0 = 100e5;           % Amplitude of the input E-field / E_f
...
for i = 2:Nt                    % 2 to 1000 in steps of 1
    ...
    % Input
    InputL(i) = Ef1(t, 0);  % At time t, we input a signal characterized by InputParasL from the left
    ...
    if mod(i,1000) == 0       % Only executed when i is multiple of plotN
